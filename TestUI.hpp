...
public:
    ...
    bool Setup() {
        ...
        MR::UIElement* ui_test_box = new MR::UIElement(MR::UIManager::Instance(), MR::Rect(25.0f, 25.0f, 25.0f, 50.0f));
        ui_test_box->SetColor(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f));

        MR::UIElement* ui_test_box2 = new MR::UIElement(MR::UIManager::Instance(), MR::Rect(25.0f, 0.0f, 50.0f, 50.0f));
        ui_test_box2->SetColor(glm::vec4(0.0f, 1.0f, 0.0f, 1.0f));
        ui_test_box->Add(ui_test_box2);
